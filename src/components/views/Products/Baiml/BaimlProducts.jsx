            ...
            <Accordion type="single" collapsible>
              <AccordionItem value="farosBaimlInfo">
                ...
                <AccordionContent className="text-gray-700 px-0 md:px-2 text-xs md:text-sm">
                  <p>
                    Descubre toda la línea de{" "}
                    <strong className={strongStyles}>Faros Baiml</strong> en
                    nuestra web, donde encontrarás modelos originales de alta
                    calidad. Somos especialistas en{" "}
                    <strong className={strongStyles}>
                      {" "}
                      faros para camiones{" "}
                    </strong>
                    , <strong className={strongStyles}>trailers</strong> y{" "}
                    <strong className={strongStyles}>faros universales</strong>.
                    Con garantía y envío a todo el país, te ayudamos a encontrar
                    el faro ideal para tu vehículo y optimizar tu seguridad en
                    la carretera. Explora la calidad y el rendimiento
                    inigualables que solo los{" "}
                    <strong className={strongStyles}>Faros Baiml </strong>
                    pueden ofrecerte.
                  </p>
                </AccordionContent>
              </AccordionItem>
