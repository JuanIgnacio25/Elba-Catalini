  ...
  return (
    <div className="products-main-fallback-container">
      <div className="products-main-fallback">
        <div className="products-main-fallback-categories">
        ...
        <div className="products-main-fallback-responsive-buttons">
          <div
            className={`${
              enabled
                ? "products-categories-simplified-view-button-container "
          ...
          <button className="px-3 py-1 rounded-md text-white font-semibold bg-red-600">
            Filtros
          </button>
        </div>
